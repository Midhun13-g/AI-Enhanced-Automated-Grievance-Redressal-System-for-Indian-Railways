    ...
    return (
        <section className="bg-gradient-to-br from-orange-50 to-white rounded-2xl shadow-xl border border-orange-200 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    type="submit"
                    className="w-full md:w-auto bg-gradient-to-r from-[#7b1f2b] to-[#f57c00] text-white px-8 py-3 rounded-lg hover:from-orange-700 hover:to-orange-600 font-semibold text-lg shadow-md transition"
                >
                    Submit Grievance
                </button>
            </form>
